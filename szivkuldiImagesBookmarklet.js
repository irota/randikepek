	...
	(function () {
		...
		var aaa = function (jQuery) {
			...
			function calcBigImg(imgElement) {
				...
				imgTarget = imgTarget.replace(/thumbmini/g, "thumbs");
			...
			jQuery("#imgov").mousedown(function (event) {
			...
			jQuery("#bigoverlay").click(function () {
		...
		if (!window.jQuery) {
			...
			jQueryScript.src = "https://www.szivkuldi.hu/tars/jquery-1.2.6.min.js";
			//jQueryScript.onload = ;
